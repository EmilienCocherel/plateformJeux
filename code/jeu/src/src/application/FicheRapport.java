...
public class FicheRapport extends GridPane{
    ...
    public void setJeu(Rapport r){
        this.nomJeu.setText(r.getNomJeu());
        this.description.setText(r.getDescription());
        this.jarJeu.setText(r.getJarJeu());
    ...
    public Rapport getJeu(){
	    ...
	    return new Rapport(id, nomJeu, description, jar, isActif, typejeu);
    }
