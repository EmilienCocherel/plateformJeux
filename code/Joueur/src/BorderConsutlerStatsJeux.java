...
public class BorderConsutlerStatsJeux extends PageJoueur {
    ...
    public BorderConsutlerStatsJeux(AJEL app){
        super();
        this.app = app;
        ...
        this.setTop(haut);
        this.setCenter(this.buttonBarTypePageJoueur(jeux,adversaire));
        this.setBottom(this.tableauTypePageJouer("Nom jeu","% de victoires","Score Moyen"));
